...
- (UITextView *)placeholderTextView{
    if (!_placeholderTextView) {
        ...
        _placeholderTextView.layer.cornerRadius = 5;
        _placeholderTextView.font = [UIFont systemFontOfSize:14];
        _placeholderTextView.textColor = [UIColor colorWithRed:143/255 green:147/255 blue:148/255 alpha:0.6];
    }
