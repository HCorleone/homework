...
//        self.tintColor = [UIColor clearColor];
        ...
        [self setSearchFieldBackgroundImage:[UIImage imageWithColor:[UIColor whiteColor] size:CGSizeMake(100, 34)] forState:UIControlStateNormal];
        
        self.originPositionSearchOffSet = UIOffsetMake(5, 0);
        //搜索图标偏移
...
//        [self setSearchFieldBackgroundPositionAdjustment:UIOffsetMake(10, 0)];
        //文字距离搜索图标的偏移，默认是紧挨着的
        [self setSearchTextPositionAdjustment:UIOffsetMake(10.5, 0)];
