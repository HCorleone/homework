...
- (void)showEditorView {
    ...
    [whiteView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(SCREEN_HEIGHT * 0.185);
        make.size.mas_equalTo(CGSizeMake(SCREEN_WIDTH * 0.797, SCREEN_HEIGHT * 0.385));
    ...
    for (int i = 0 ; i < 3; i++) {
        ...
        _nameLabel.frame = CGRectMake(SCREEN_WIDTH * 0.18, SCREEN_HEIGHT * 0.256 + SCREEN_HEIGHT * 0.093 * i, SCREEN_WIDTH * 0.128, 16);
    }
    ...
    _nameField.frame = CGRectMake(SCREEN_WIDTH * 0.308, SCREEN_HEIGHT * 0.245, SCREEN_WIDTH * 0.513, 30);
    ...
    _downBtn.frame = CGRectMake(SCREEN_WIDTH * 0.308, SCREEN_HEIGHT * 0.339, SCREEN_WIDTH * 0.513, 30);
    ...
    _cityBtn.frame = CGRectMake(SCREEN_WIDTH * 0.308, SCREEN_HEIGHT * 0.433, SCREEN_WIDTH * 0.513, 30);
