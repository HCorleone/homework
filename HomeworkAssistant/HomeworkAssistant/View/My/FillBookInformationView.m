...
-(id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        for (int i = 0; i < 5; i ++) {
            ...
            _nameLabel.frame = CGRectMake(SCREEN_WIDTH * 0.084, SCREEN_HEIGHT * 0.155 + SCREEN_HEIGHT * 0.077 * i, 50, 14);
        }
        ...
        [bgc mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(SCREEN_HEIGHT * 0.138);
            make.right.mas_equalTo(-SCREEN_WIDTH * 0.084);
        ...
        [_inputField mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(SCREEN_HEIGHT * 0.138);
            make.right.mas_equalTo(-SCREEN_WIDTH * 0.084);
            make.width.mas_equalTo(SCREEN_WIDTH * 0.666);
            make.height.mas_equalTo(37);
        }];
        ...
        [_chooseBtn1 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(SCREEN_HEIGHT * 0.214);
            make.right.mas_equalTo(-SCREEN_WIDTH * 0.084);
            make.width.mas_equalTo(SCREEN_WIDTH * 0.693);
            make.height.mas_equalTo(37);
        }];
        ...
        [_chooseBtn2 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(SCREEN_HEIGHT * 0.291);
            make.right.mas_equalTo(-SCREEN_WIDTH * 0.084);
            make.width.mas_equalTo(SCREEN_WIDTH * 0.693);
            make.height.mas_equalTo(37);
        }];
        ...
        [_chooseBtn3 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(SCREEN_HEIGHT * 0.367);
            make.right.mas_equalTo(-SCREEN_WIDTH * 0.084);
            make.width.mas_equalTo(SCREEN_WIDTH * 0.693);
            make.height.mas_equalTo(37);
        }];
        ...
        [bgc2 mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(SCREEN_HEIGHT * 0.443);
            make.right.mas_equalTo(-SCREEN_WIDTH * 0.084);
            make.width.mas_equalTo(SCREEN_WIDTH * 0.693);
            make.height.mas_equalTo(37);
        }];
