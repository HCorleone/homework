...
-(void)getAnswer {
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 307, SCREENWIDTH, 112) collectionViewLayout:layout];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info
{
    ...
    if (_isAnswer) {
        ...
        //更新宽度
        _collectionView.contentSize = CGSizeMake(84 * _imgArray.count, 112);
//        _collectionView.contentOffset = 84 * _imgArray.count;
    }
    else
    {
        //获取编辑后的图片
