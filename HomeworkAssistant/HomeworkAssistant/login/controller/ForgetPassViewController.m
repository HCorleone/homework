...
- (void)setUpViews {
    ...
    enrollView.typeLabel.text = @"修改密码";
...
-(void)toenroll{
    ...
    [manager GET:[Consts USER_CHANGEPASS] parameters:param success:^(NSURLSessionTask *operation, id responseObject) {
        NSError *error = nil;
