...
//            textField.layer.cornerRadius = 0;
    ...
    headerView.py_height = 0.51 * PYSEARCH_REALY_SCREEN_WIDTH;
...
//    hotSearchView.py_height = 0.48 * PYSEARCH_REALY_SCREEN_WIDTH;
...
//    [hotSearchView addSubview:titleLabel];
    ...
    hotSearchTagsContentView.backgroundColor = [UIColor whiteColor];
...
//    hotSearchTagsContentView.py_y = PYSEARCH_MARGIN;
    hotSearchTagsContentView.py_y = 0;
    hotSearchTagsContentView.py_x = 20;
    hotSearchTagsContentView.py_width = PYSEARCH_REALY_SCREEN_WIDTH - 40;
    ...
    //分割线
//    UILabel *line = [[UILabel alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(hotSearchTagsContentView.frame) + , PYSEARCH_REALY_SCREEN_WIDTH, 0.02 * PYSEARCH_REALY_SCREEN_WIDTH)];
//    line.backgroundColor = [UIColor colorWithRed:247.0/255.0 green:249.0/255.0 blue:250.0/255.0 alpha:80];
//    [hotSearchView addSubview:line];
...
//    footerView.py_height = emptySearchHistoryLabel.py_height;
    ...
    [emptyBtn addTarget:self action:@selector(emptySearchHistoryDidClick) forControlEvents:UIControlEventTouchUpInside];
    [emptyBtn setImage:[NSBundle py_imageNamed:@"全部删除记录"] forState:UIControlStateNormal];
    emptyBtn.py_size = CGSizeMake(96, 43);
    emptyBtn.py_x = PYSEARCH_REALY_SCREEN_WIDTH/2 - 48;
    emptyBtn.py_y = 0;
    [footerView addSubview:emptyBtn];
    footerView.py_height = 49;
...
- (void)setupHotSearchRectangleTags
{
    ...
    self.baseSearchTableView.tableFooterView.py_height = self.footerView.py_height = 49;
    ...
    [self.baseSearchTableView setTableFooterView:self.baseSearchTableView.tableFooterView];
}
...
{
    self.baseSearchTableView.tableFooterView = self.footerView;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        cell.textLabel.textColor = [UIColor py_colorWithHexString:@"#939699"];
...
{
    return self.searchHistories.count && self.showSearchHistory && PYSearchHistoryStyleCell == self.searchHistoryStyle ? 30 : 0.01;
}
